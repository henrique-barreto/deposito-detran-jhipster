...
export type IPerfilState = IPaginationBaseState;

export class Perfil extends React.Component<IPerfilProps, IPerfilState> {
  state: IPerfilState = {
  ...
  render() {
    const { perfilList, match, totalItems } = this.props;
    return (
      <div>
        ...
        <div className="table-responsive">
          {perfilList && perfilList.length > 0 ? (
            <Table responsive aria-describedby="perfil-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('ativo')}>
                    Ativo <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">No Perfils found</div>
          )}
        </div>
        <div className={perfilList && perfilList.length > 0 ? '' : 'd-none'}>
