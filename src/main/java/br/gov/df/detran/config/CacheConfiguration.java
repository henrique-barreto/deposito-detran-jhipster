package br.gov.df.detran.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.gov.df.detran.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.gov.df.detran.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, br.gov.df.detran.domain.Pessoa.class.getName());
