...
import br.gov.df.detran.config.audit.AuditEventConverter;
import br.gov.df.detran.domain.PersistentAuditEvent;
...
import static br.gov.df.detran.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
