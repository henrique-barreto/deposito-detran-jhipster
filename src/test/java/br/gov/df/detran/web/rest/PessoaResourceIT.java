...
import br.gov.df.detran.domain.Pessoa;
import br.gov.df.detran.repository.PessoaRepository;
...
public class PessoaResourceIT {
    ...
    public void createPessoa() throws Exception {
        ...
        assertThat(testPessoa.getData()).isEqualTo(DEFAULT_DATA);
    }
    ...
    public void updatePessoa() throws Exception {
        ...
        assertThat(testPessoa.getData()).isEqualTo(UPDATED_DATA);
    }
