...
import br.gov.df.detran.config.Constants;
import br.gov.df.detran.domain.Authority;
import br.gov.df.detran.domain.User;
import br.gov.df.detran.repository.AuthorityRepository;
import br.gov.df.detran.repository.UserRepository;
import br.gov.df.detran.security.AuthoritiesConstants;
import br.gov.df.detran.service.MailService;
import br.gov.df.detran.service.UserService;
import br.gov.df.detran.service.dto.PasswordChangeDTO;
import br.gov.df.detran.service.dto.UserDTO;
import br.gov.df.detran.web.rest.errors.ExceptionTranslator;
import br.gov.df.detran.web.rest.vm.KeyAndPasswordVM;
import br.gov.df.detran.web.rest.vm.ManagedUserVM;
