package br.gov.df.detran.config.timezone;

import br.gov.df.detran.DepositoDetranJhipsterApp;
import br.gov.df.detran.repository.timezone.DateTimeWrapper;
import br.gov.df.detran.repository.timezone.DateTimeWrapperRepository;
